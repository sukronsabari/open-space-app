...
describe('asyncPopulateUsersAndTalks thunk', () => {
  ...
  it('should dispatch action correctly when data fetching success', async () => {
    // arrange
    // stub implementation, memalsukan implementasi fungsi
    api.getAllUsers = () => Promise.resolve(fakeUsersResponse);
    api.getAllTalks = () => Promise.resolve(fakeTalksResponse);

    // mock dispatch, meniru object dispatch u. mengevaluasi penggunaan fungsi dispatch
  ...
  it('should dispatch action and call alert correctly when data fetching failed', async () => {
    ...
    // mock dispatch, meniru object dispatch
    const dispatch = jest.fn();
